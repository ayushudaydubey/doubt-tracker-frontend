                ...
                <div className="bg-gradient-to-br from-green-900/20 to-emerald-900/20 border border-green-700/30 p-4 sm:p-5 rounded-xl shadow-lg backdrop-blur-sm">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 mb-3 text-xs">
                    <div className="bg-gray-800/50 border border-gray-700/50 p-2.5 rounded-lg">
                      <p className="text-gray-500 text-[10px] mb-1">Mentor</p>
                      <p className="font-medium text-gray-200">{doubt.mentor?.name || "N/A"}</p>
                    </div>
                    <div className="bg-gray-800/50 border border-gray-700/50 p-2.5 rounded-lg">
                      <p className="text-gray-500 text-[10px] mb-1">Email</p>
                      <p className="font-medium text-gray-200 truncate">{doubt.mentor?.email || "N/A"}</p>
                    </div>
                    <div className="bg-gray-800/50 border border-gray-700/50 p-2.5 rounded-lg">
                      <p className="text-gray-500 text-[10px] mb-1">Contact</p>
                      <p className="font-medium text-gray-200">{doubt.mentor?.mobile || "N/A"}</p>
                    </div>
                  </div>
