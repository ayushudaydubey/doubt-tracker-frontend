    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-black to-gray-900 text-gray-200 px-4 sm:px-6 lg:px-8 pt-24 pb-12">
      ...
      <div className="max-w-7xl mx-auto mb-8">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-gray-400 text-sm">Track and manage your doubt tickets</p>
          </div>
          <div className="flex items-center gap-3">
            <div className="bg-gray-800/50 backdrop-blur-sm px-4 py-2 rounded-full border border-gray-700">
              <span className="text-gray-400 text-sm">Total:</span>
              <span className="text-green-400 font-bold text-lg ml-2">{doubts.length}</span>
            </div>
            <Link
              to="/doubts/create"
              className="inline-flex items-center gap-2 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-400 hover:to-emerald-500 text-white px-5 py-2.5 rounded-lg font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-green-500/30 group"
            >
      ...
      {loading ? (
        <div className="flex flex-col justify-center items-center min-h-[400px]">
          ...
          <p className="mt-4 text-gray-400 animate-pulse">Loading your tickets...</p>
        </div>
      ) : doubts.length === 0 ? (
        <div className="flex flex-col items-center justify-center min-h-[400px] bg-gray-900/50 rounded-2xl border border-gray-800">
          ...
          <p className="text-gray-600 text-sm mt-2">Create your first ticket to get started!</p>
          <Link
            to="/doubts/create"
            className="mt-6 inline-flex items-center gap-2 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-400 hover:to-emerald-500 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-green-500/30"
          >
        ...
        <>
          {/* Cards Grid */}
          <div className="max-w-4xl mx-auto grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
                  ...
                  <div className="p-3">
                    ...
                    <div className="flex gap-2 flex-wrap">
                      <Link 
                        ...
                        className="inline-flex items-center gap-1.5 text-xs font-semibold text-white bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 px-3 py-1.5 rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/30 group/btn"
                      >
                      ...
                      {!isResolved && (
                        <>
                          <Link 
                            ...
                            className="inline-flex items-center gap-1.5 text-xs font-semibold text-white bg-gradient-to-r from-yellow-600 to-yellow-700 hover:from-yellow-500 hover:to-yellow-600 px-3 py-1.5 rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-yellow-500/30"
                          >
                            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <button 
                            ...
                            className="inline-flex items-center gap-1.5 text-xs font-semibold text-white bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 px-3 py-1.5 rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-red-500/30"
                          >
                            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
