    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50 px-3 sm:px-4 lg:px-6 py-6 sm:py-8 lg:pt-24 pb-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-b-2xl shadow-lg overflow-hidden">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                  <div>
                    ...
                    <span className="ml-2 text-gray-700">{doubt.student?.name || "N/A"}</span>
                  </div>
                  <div>
                    <span className="text-blue-600 font-medium">Email:</span>
                    <span className="ml-2 text-gray-700 truncate block">{doubt.student?.email || "N/A"}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                  <input 
                    ...
                    className="text-xs sm:text-sm text-gray-600 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 file:cursor-pointer cursor-pointer"
                  />
                  <button
                    onClick={handleSendMessage}
                    className="px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg font-semibold hover:from-blue-600 hover:to-blue-700 transition-all shadow-md hover:shadow-lg text-sm sm:text-base whitespace-nowrap flex items-center justify-center gap-2"
                  >
            ...
            <div className="border-t border-gray-200 bg-gray-50 p-4 sm:p-6 lg:p-8">
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  ...
                  className="flex-1 sm:flex-none px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-lg font-semibold hover:from-green-600 hover:to-green-700 transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2 text-sm sm:text-base"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {doubt.status === "resolved" && (
            <div className="border-t border-gray-200 bg-green-50 p-4 sm:p-6 lg:p-8">
